...
ai = media.Movie('AI',
                 ...
                 ,
                 'http://www.gstatic.com/tv/thumb/movieposters/27945/p27945_p_v8_ai.jpg'
...
indiana = media.Movie('Indiana Jones: The Last Crusade',
                      'Indiana Jones goes on a quest to find the magical goblet'
                      ,
                      'http://t1.gstatic.com/images?q=tbn:ANd9GcTvapMUYGkuF5IrOsugBN3-kAIMHEhGu2exzQErGjVMiXCHtCmA'
                      , 'https://www.youtube.com/watch?v=a6JB2suJYHM')

wonder = media.Movie('Wonder Woman',
                     'She fights a war to end all wars and discovers her true destiny'
                     ,
